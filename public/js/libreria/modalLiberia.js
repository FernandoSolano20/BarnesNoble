...
function crearFomrulario(cuerpoModal, libreria) {
  ...
  inputNombreComercial.setAttribute('id', 'nombreComercial');
  ...
  inputNombreFantasia.setAttribute('id', 'nombreFantasia');
  ...
  inputCanton.setAttribute('id', 'canton');
  ...
  inputDistrito.setAttribute('id', 'distrito');
