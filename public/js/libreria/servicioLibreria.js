...
let editarLibreria = async(libreria,id) => {
    let response = await fetch('http://localhost:4000/api/editar/' + id, {
        method: "PUT",
        headers: {
            'Content-Type': 'application/json;charset=UTF-8',
        },
...
let eliminarLibreria = async(id) => {
    let response = await fetch('http://localhost:4000/api/eliminar/' + id, {
        method: "DELETE",
        headers: {
            'Content-Type': 'application/json;charset=UTF-8',
        },
...
let estadoLibreria = async(libreria,id) => {
    let response = await fetch('http://localhost:4000/api/modificarEstado/' + id, {
        method: "PATCH",
        headers: {
            'Content-Type': 'application/json;charset=UTF-8',
        },
