    ...
    if (accion === 'crear') {
      ...
      if (accion === 'editar') {
        ...
        if (!checkBoxEstado.checked) {
          tituloModal.innerText = 'Desactivar oferta: ' + genero.nombre;
          textoModal.innerText = '¿Está seguro que quiere desactivar esta oferta?';
        }
        else {
          tituloModal.innerText = 'Activar oferta: ' + genero.nombre;
          textoModal.innerText = '¿Está seguro que quiere activar esta oferta?';
        }
      }
    }
